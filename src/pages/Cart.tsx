        ...
        <Button bgColor='red' borderColor={'red'} color={'white'} _hover={{bgColor: 'red.900'}} marginBottom={5} onClick={()=> clear()}>🗑<Text marginLeft={1}>Clear all</Text></Button>
          <SimpleGrid  columns={{sm: 1, md: 2, lg: 3, xl: 4}}  spacing={6}>
                {items.game.map(g=> (
                    ...
                    <NavLink to={'/games/' + g.slug}><Image src={getCroppedImageUrl(g.background_image)} objectFit='cover' width={'full'} height={'full'} alt={g.name}/></NavLink>
                    <CardBody>
                        ...
                        <Box marginTop={1}>
                            ...
                            <Center marginTop={5}>
                                    <Button onClick={()=> remove(g.id)} gap={2} width="100%" variant='solid' textColor='chakra-body-text._light' transition={'all .15s ease-in'}  color='white' bgColor='red' borderColor='red' _hover={{bgColor:'red.900', borderColor:'red'}}> Remove</Button>
                            </Center>
                        </Box>
                    </CardBody>
                </Card>
